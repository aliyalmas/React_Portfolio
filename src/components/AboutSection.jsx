        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
              ...
              <a
                href="https://www.overleaf.com/download/project/68a89ff9d36901a287ec842c/build/19b04530ba4-ba8d1a231d61db25/output/output.pdf?compileGroup=standard&clsiserverid=clsi-pre-emp-c3d-c-f-bn7v&popupDownload=true"
